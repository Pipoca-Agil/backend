...
const UserZodSchema = z.object({
  name: z.string({
    ...
    .regex(/^[a-zA-Z]+$/, { message: 'Não é permitido uso de números e caracteres especiais em nome.' }),
  ...
  surname: z.string({
    ...
    .regex(/^[a-zA-Z]+$/, { message: 'Não é permitido uso de números e caracteres especiais em sobrenome.' }),
